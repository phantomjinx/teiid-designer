...
#
MVN_FLAGS="${MVN_FLAGS} -Dtpc.version=4.40.0.Alpha1-SNAPSHOT -P target-platform,multiple.target -Dmaven.repo.local=${LOCAL_REPO} -Dno.jbosstools.site -Dtycho.localArtifacts=ignore"
