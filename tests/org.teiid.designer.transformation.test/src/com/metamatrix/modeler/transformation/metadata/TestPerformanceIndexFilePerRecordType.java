...
public class TestPerformanceIndexFilePerRecordType extends TestCase {
    ...
    private static final String TEST_INDEX_DIRECTORY_PATH = SmartTestDesignerSuite.getTestDataPath(TestPerformanceIndexFilePerRecordType.class);
    // private static final String TEST_INDEX_FILE_PATH = TEST_INDEX_DIRECTORY_PATH + File.separator + TEST_INDEX_FILE_NAME;
    private static final String FAKE_FILE_PATH = SmartTestDesignerSuite.getTestDataPath(TestPerformanceIndexFilePerRecordType.class) + File.separator + "PartsRelational.mmm"; //$NON-NLS-1$
