...
public class EquinoxPasswordProvider extends PasswordProvider {
    ...
    public PBEKeySpec getPassword(IPreferencesContainer container, int passwordType) {
        ...
        final EquinoxStorageLoginDialog loginDialog = new EquinoxStorageLoginDialog(newPassword, passwordChange, location);
